...
def match_manifestation(mak_manif, index_245=None, index_490=None, index_id=None):
    ...
    if cand_1_245:
        candidates_245.update(index_245.get(mak_manif_data.title_245_no_offset))
    if cand_2_245:
            ...
            if match_type == '245':
                if (bn_manif_data.isbn_020_az and mak_manif_data.isbn_020_az and \
                   ...
                   mak_manif_data.isbn_020_az):
                    ...
                    match = True if last_5_char_245 and num_245 and place_pub_260 and num_pages and b_form else False
                    if match:
                ...
                if bn_manif_data.isbn_020_az and mak_manif_data.isbn_020_az and \
                   bn_manif_data.isbn_020_az == mak_manif_data.isbn_020_az:
                    ...
                    match = True if (num_245 and place_pub_260 and num_pages and b_form) or \
                                    (last_5_char_245 and place_pub_260 and num_pages and b_form) or \
